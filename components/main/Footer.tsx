...
const Footer = () => {
  return (
    <div className="w-full mt-20 h-full bg-transparent text-gray-200 shadow-lg p-[15px] ">
                ...
                <div className="min-w-[200px] h-auto flex flex-col items-center justify-start">
                   ...
                   {/* <p className="flex flex-row items-center my-[15px] cursor-pointer">
                    ...
                    <p className="flex flex-row items-center my-[15px] cursor-pointer">
                        ...
                        <span className="text-[15px] ml-[6px]">anandagharami.am@gmail.com</span>    
                    </p>
                </div>
            </div>

            <div className="mb-[20px] text-[15px] text-center">
                &copy; Ananda Gharami {(new Date()).getFullYear()} Inc. All rights reserved
            </div>
        </div>
    </div>
  )
